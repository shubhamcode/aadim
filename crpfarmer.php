...
<br>
<hr>
<h3>Below is the list of Farmers Under:CRPs</h3>
<table bgcolor="#330099" style=" margin-bottom:10px;">
<tr style="height:50px;"><td style="width:120px; background-color:#C00;"><h3>UID</h3></td><td style="width:220px; background-color:#C00;"><h3>Name</h3></td><td style="width:120px; background-color:#C00;"><h3>Village</h3></td><td style="width:120px; background-color:#C00;"><h3>Gram Panchayat</h3></td><td style="width:120px; background-color:#C00;"><h3>Mobile No.</h3></td></tr>

<?php
 mysql_select_db("dantewada");
           			$gu=$_GET['ffid'];
					$b=mysql_query("Select * from personal where crp='$gu'",$con);
					$c=mysql_query("Select * from fcontact where crp='$gu'",$con);
            $ln=mysql_num_rows($b);
