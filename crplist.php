...
<br>
<hr>
<h3>Below is the list of already Registered CRPs:</h3>
<table bgcolor="#330099" style=" margin-bottom:10px;">
<tr style="height:50px;"><td style="width:200px; background-color:#C00;"><h3>Name of Farmer/CRP</h3></td><td style="width:120px; background-color:#C00;"><h3>Mobile No.</h3></td><td style="width:30px; background-color:#C00;"><h3>Gender</h3></td><td style="width:250px; background-color:#C00;"><h3>Email ID</h3></td><td style="width:250px; background-color:#C00;"><h3>Address</h3></td><td style="width:100px; background-color:#C00;"><h3>Group</h3></td><td style="width:200px; background-color:#C00;"><h3>Password</h3></td></tr>

<?php
 mysql_select_db("dantewada");
           $b=mysql_query("Select * from crp",$con);
            $ln=mysql_num_rows($b);
			for($i=0;$i<$ln;$i++)
			{
				echo "<tr>";
