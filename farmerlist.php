<html>
<title>aadim/admin/farmer-list</title>
<head>
...
<br>
<hr>
<h3>Below is the list of already Registered Farmers:</h3>
<table bgcolor="#330099" style=" margin-bottom:10px;">
<tr style="height:50px;"><td style="width:120px; background-color:#C00;"><h3>UID</h3></td><td style="width:220px; background-color:#C00;"><h3>Name</h3></td><td style="width:120px; background-color:#C00;"><h3>Village</h3></td><td style="width:120px; background-color:#C00;"><h3>Gram Panchayat</h3></td><td style="width:120px; background-color:#C00;"><h3>Mobile No.</h3></td><td style="width:220px; background-color:#C00;"><h3>CRP Name</h3></td></tr>

<?php
 mysql_select_db("dantewada");
           $b=mysql_query("Select * from personal",$con);
		   $c=mysql_query("Select * from fcontact",$con);
            $ln=mysql_num_rows($b);
